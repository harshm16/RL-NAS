...
def collect_control_performance(epochs, num_classes, train_loader, test_loader):
    ...
    plot_performance(epochs, 'Control loss', train_losses, test_losses,'Traditional CNN evaluation')
    plot_performance(epochs, 'Control accuracy', train_accuracies, test_accuracies,'Traditional CNN evaluation')

    performance = sum(test_accuracies) / (epochs)
    print(f"##################################\n"
...
def evaluate_child(epochs, selected_set, num_classes, train_loader, test_loader,iteration):
    print(f"##################################\n"
    ...
    # desc = 'iteration'+ str(iteration) + '-' + str(selected_set)
    desc = 'iteration'+ str(iteration) + str(selected_set)

    plot_performance(epochs, 'Child loss', train_losses, test_losses,desc)
    plot_performance(epochs, 'Child accuracy', train_accuracies, test_accuracies,desc)
