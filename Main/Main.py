...
if __name__ == '__main__':
    ...
    for iteration in range(num_iterations):
        ...
        reward = evaluate_child(child_train_epochs, translate(selected_operations), num_classes, train_loader, test_loader,iteration)
        rewards += [reward]
    ...
    plt.savefig("ControllerLoss_vs_Iterations"+'_main_2ndrun.png')
    ...
    plt.savefig("ControllerPerformance_vs_Iterations"+'_main_2ndrun.png')
    # plt.show()
    plt.close()
